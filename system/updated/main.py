...
class System_App:
    def __init__(self, root):
        ...
        title = Label(self.root, text='Restarunt MAZAK System', font=('times new roman', 26, 'bold'), bd=12,
                      relief=GROOVE, pady=1, bg=bg_color, fg='yellow').pack(fill=X)
        ...
        Lb1.place(x=0, y=60, relwidth=1)

        C_name_Lb = Label(Lb1, text='Customar Name', font=('times new roman', 18, 'bold'), bg=bg_color, fg='white')
        C_name_Lb.grid(row=0, column=0, padx=15, pady=5)
        C_name_txt = Entry(Lb1, width=15, font=('arial', 15), bd=7, relief=SUNKEN, textvariable=self.C_name)\
            .grid(row=0, column=1, padx=10, pady=5)

        C_phone_Lb = Label(Lb1, text='Phone No.', font=('times new roman', 18, 'bold'), bg=bg_color, fg='white')
        C_phone_Lb.grid(row=0, column=2, padx=15, pady=5)
        C_phone_txt = Entry(Lb1, width=15, font=('arial', 15), bd=7, relief=SUNKEN, textvariable=self.C_phone)\
            .grid(row=0, column=3, padx=10, pady=5)

        C_Order_Lb = Label(Lb1, text='Order Number', font=('times new roman', 18, 'bold'), bg=bg_color, fg='white')
        C_Order_Lb.grid(row=0, column=4, padx=15, pady=5)
        C_Order_txt = Entry(Lb1, width=15, font=('arial', 15), bd=7, relief=SUNKEN, textvariable=self.search_order)\
            .grid(row=0, column=5, padx=10, pady=5)

        Order_button = Button(Lb1, width=9, text='search', bd=7, font=('arial', 12, 'bold'), command=self.Find_Order)\
            .grid(row=0, column=6, padx=10, pady=5)

        # *********** food Frame *********
        Lb2 = LabelFrame(root, text='Food', font=('times new roman', 18, 'bold'), bd=10, relief=GROOVE, pady=2, bg=bg_color, fg='gold')
        Lb2.place(x=0, y=150, width=270, height=340)

        Burger_Lb = Label(Lb2, text='Burger', font=('times new roman', 16, 'bold'), bg=bg_color, fg='white')
        Burger_Lb.grid(row=0, column=0, padx=5, pady=8, sticky='w')
        Burger_txt = Entry(Lb2, width=6, font=('times new roman', 14, 'bold'), bd=5, relief=SUNKEN, textvariable=self.Burger)\
            .grid(row=0, column=1, padx=5, pady=8)

        Pizza_Lb = Label(Lb2, text='Pizza', font=('times new roman', 16, 'bold'), bg=bg_color, fg='white')
        Pizza_Lb.grid(row=1, column=0, padx=5, pady=8, sticky='w')
        Pizza_txt = Entry(Lb2, width=6, font=('times new roman', 14, 'bold'), bd=5, relief=SUNKEN, textvariable=self.Pizza)\
            .grid(row=1, column=1, padx=5, pady=8)

        Spaghetti_Lb = Label(Lb2, text='Spaghetti', font=('times new roman', 16, 'bold'), bg=bg_color, fg='white')
        Spaghetti_Lb.grid(row=2, column=0, padx=5, pady=8, sticky='w')
        Spaghetti_txt = Entry(Lb2, width=6, font=('times new roman', 14, 'bold'), bd=5, relief=SUNKEN, textvariable=self.Spaghetti)\
        ...
        Chicken_Naggets_Lb.grid(row=3, column=0, padx=5, pady=8, sticky='w')
        Chicken_Naggets_txt = Entry(Lb2, width=6, font=('times new roman', 14, 'bold'), bd=5, relief=SUNKEN, textvariable=self.Chicken_Naggets)\
            .grid(row=3, column=1, padx=5, pady=8)

        Mexican_Tacos_Lb = Label(Lb2, text='Mexican Tacos', font=('times new roman', 16, 'bold'), bg=bg_color, fg='white')
        Mexican_Tacos_Lb.grid(row=4, column=0, padx=5, pady=8, sticky='w')
        Mexican_Tacos_txt = Entry(Lb2, width=6, font=('times new roman', 14, 'bold'), bd=5, relief=SUNKEN, textvariable=self.Mexican_Tacos)\
            .grid(row=4, column=1, padx=5, pady=8)

        Hotdog_Lb = Label(Lb2, text='Hotdog', font=('times new roman', 16, 'bold'), bg=bg_color, fg='white')
        Hotdog_Lb.grid(row=5, column=0, padx=5, pady=8, sticky='w')
        Hotdog_txt = Entry(Lb2, width=6, font=('times new roman', 14, 'bold'), bd=5, relief=SUNKEN, textvariable=self.Hotdog)\
            .grid(row=5, column=1, padx=5, pady=8)

        # *********** drinks Frame *********
        Lb3 = LabelFrame(root, text='Drinks', font=('times new roman', 18, 'bold'), bd=10,
                         relief=GROOVE, pady=2, bg=bg_color, fg='gold')
        Lb3.place(x=270, y=150, width=240, height=340)

        Apple_Lb = Label(Lb3, text='Apple Juice', font=('times new roman', 16, 'bold'), bg=bg_color, fg='white')
        Apple_Lb.grid(row=0, column=0, padx=5, pady=8, sticky='w')
        Apple_txt = Entry(Lb3, width=6, font=('times new roman', 14, 'bold'), bd=5, relief=SUNKEN, textvariable=self.Apple)\
            .grid(row=0, column=1,padx=5,pady=8)

        Orange_Lb = Label(Lb3, text='Orange Juice', font=('times new roman', 16, 'bold'), bg=bg_color, fg='white')
        Orange_Lb.grid(row=1, column=0, padx=5, pady=8, sticky='w')
        Orange_txt = Entry(Lb3, width=6, font=('times new roman', 14, 'bold'), bd=5, relief=SUNKEN, textvariable=self.Orange)\
            .grid(row=1, column=1, padx=5, pady=8)

        Mango_Lb = Label(Lb3, text='Mango Juice', font=('times new roman', 16, 'bold'), bg=bg_color, fg='white')
        Mango_Lb.grid(row=2, column=0, padx=5, pady=8, sticky='w')
        Mango_txt = Entry(Lb3, width=6, font=('times new roman', 14, 'bold'), bd=5, relief=SUNKEN, textvariable=self.Mango)\
            .grid(row=2, column=1, padx=5, pady=8)

        Lemonade_Lb = Label(Lb3, text='Lemonade', font=('times new roman', 16, 'bold'), bg=bg_color, fg='white')
        Lemonade_Lb.grid(row=3, column=0, padx=5, pady=8, sticky='w')
        Lemonade_txt = Entry(Lb3, width=6, font=('times new roman', 14, 'bold'), bd=5, relief=SUNKEN, textvariable=self.Lemonade)\
            .grid(row=3, column=1,padx=5, pady=8)

        Coffe_Lb = Label(Lb3, text='Coffe', font=('times new roman', 16, 'bold'), bg=bg_color, fg='white')
        Coffe_Lb.grid(row=4, column=0, padx=5, pady=8, sticky='w')
        Coffe_txt = Entry(Lb3, width=6, font=('times new roman', 14, 'bold'), bd=5, relief=SUNKEN, textvariable=self.Coffe)\
            .grid(row=4, column=1,padx=5,pady=8)

        Cold_Drinks_Lb = Label(Lb3, text='Cold Drinks', font=('times new roman', 16, 'bold'), bg=bg_color, fg='white')
        Cold_Drinks_Lb.grid(row=5, column=0, padx=5, pady=8, sticky='w')
        Cold_Drinks_txt = Entry(Lb3, width=6, font=('times new roman', 14, 'bold'), bd=5, relief=SUNKEN, textvariable=self.Cold_Drinks)\
            .grid(row=5, column=1,padx=5,pady=8)

        # *********** dessert Frame *********
        Lb4 = LabelFrame(root, text='Desert', font=('times new roman', 18, 'bold'), bd=10,
                         relief=GROOVE, pady=2, bg=bg_color, fg='gold')
        Lb4.place(x=510, y=150, width=235, height=340)

        Ice_cream_Lb = Label(Lb4, text='Ice Cream', font=('times new roman', 16, 'bold'), bg=bg_color, fg='white')
        Ice_cream_Lb.grid(row=0, column=0, padx=5, pady=8, sticky='w')
        Ice_cream_txt = Entry(Lb4, width=6, font=('times new roman', 14, 'bold'), bd=5, relief=SUNKEN, textvariable=self.Ice_cream)\
            .grid(row=0, column=1, padx=5, pady=8)

        Molten_Cake_Lb = Label(Lb4, text='Molten Cake', font=('times new roman', 16, 'bold'), bg=bg_color, fg='white')
        Molten_Cake_Lb.grid(row=1, column=0, padx=5, pady=8, sticky='w')
        Molten_Cake_txt = Entry(Lb4, width=6, font=('times new roman', 14, 'bold'), bd=5, relief=SUNKEN, textvariable=self.Molten_Cake)\
            .grid(row=1, column=1, padx=5, pady=8)

        Apple_Pie_Lb = Label(Lb4, text='Apple Pie', font=('times new roman', 16, 'bold'), bg=bg_color, fg='white')
        Apple_Pie_Lb.grid(row=2, column=0, padx=8, pady=5, sticky='w')
        Apple_Pie_txt = Entry(Lb4, width=6, font=('times new roman', 14, 'bold'), bd=5, relief=SUNKEN, textvariable=self.Apple_Pie)\
            .grid(row=2, column=1, padx=5, pady=8)

        Cheese_Cake_Lb = Label(Lb4, text='Cheese Cake', font=('times new roman', 16, 'bold'), bg=bg_color, fg='white')
        Cheese_Cake_Lb.grid(row=3, column=0, padx=5, pady=8, sticky='w')
        Cheese_Cake_txt = Entry(Lb4, width=6, font=('times new roman', 14, 'bold'), bd=5, relief=SUNKEN, textvariable=self.Cheese_Cake)\
            .grid(row=3, column=1, padx=5, pady=8)

        Waffles_Lb = Label(Lb4, text='Waffles', font=('times new roman', 16, 'bold'), bg=bg_color, fg='white')
        Waffles_Lb.grid(row=4, column=0, padx=5, pady=8, sticky='w')
        Waffles_txt = Entry(Lb4, width=6, font=('times new roman', 14, 'bold'), bd=5, relief=SUNKEN, textvariable=self.Waffles)\
            .grid(row=4, column=1, padx=5, pady=8)

        Cookies_Lb = Label(Lb4, text='Cookies', font=('times new roman', 16, 'bold'), bg=bg_color, fg='white')
        Cookies_Lb.grid(row=5, column=0, padx=5, pady=8, sticky='w')
        Cookies_txt = Entry(Lb4, width=6, font=('times new roman', 14, 'bold'), bd=5, relief=SUNKEN, textvariable=self.Cookies)\
            .grid(row=5, column=1, padx=5, pady=8)
        ...
        Lb7 = LabelFrame(root, text='Appetizers', font=('times new roman', 18, 'bold'), bd=10,
                         relief=GROOVE, pady=2, bg=bg_color, fg='gold')
        Lb7.place(x=745, y=150, width=245, height=340)

        Salad_Lb = Label(Lb7, text='Salad', font=('times new roman', 16, 'bold'), bg=bg_color, fg='white')
        Salad_Lb.grid(row=0, column=0, padx=10, pady=8, sticky='w')
        Salad_txt = Entry(Lb7, width=5, font=('times new roman', 14, 'bold'), bd=5, relief=SUNKEN, textvariable=self.Salad)\
            .grid(row=0, column=1, padx=5, pady=8)

        French_Fries_Lb = Label(Lb7, text='French Fries', font=('times new roman', 16, 'bold'), bg=bg_color, fg='white')
        French_Fries_Lb.grid(row=1, column=0, padx=5, pady=8, sticky='w')
        French_Fries_txt = Entry(Lb7, width=5, font=('times new roman', 14, 'bold'), bd=5, relief=SUNKEN, textvariable=self.French_Fries)\
            .grid(row=1, column=1, padx=5, pady=8)

        Soup_Lb = Label(Lb7, text='Soup', font=('times new roman', 16, 'bold'), bg=bg_color, fg='white')
        Soup_Lb.grid(row=2, column=0, padx=5, pady=8, sticky='w')
        Soup_txt = Entry(Lb7, width=5, font=('times new roman', 14, 'bold'), bd=5, relief=SUNKEN, textvariable=self.Soup)\
            .grid(row=2, column=1, padx=5, pady=8)

        Onion_Rings_Lb = Label(Lb7, text='Onion Rings', font=('times new roman', 16, 'bold'), bg=bg_color, fg='white')
        Onion_Rings_Lb.grid(row=3, column=0, padx=5, pady=8, sticky='w')
        Onion_Rings_txt = Entry(Lb7, width=5, font=('times new roman', 14, 'bold'), bd=5, relief=SUNKEN, textvariable=self.Onion_Rings)\
            .grid(row=3, column=1, padx=5, pady=8)

        Chicken_Wings_Lb = Label(Lb7, text='Chicken Wings', font=('times new roman', 16, 'bold'), bg=bg_color, fg='white')
        Chicken_Wings_Lb.grid(row=4, column=0, padx=5, pady=8, sticky='w')
        Chicken_Wings_txt = Entry(Lb7, width=5, font=('times new roman', 14, 'bold'), bd=5, relief=SUNKEN, textvariable=self.Chicken_Wings)\
            .grid(row=4, column=1, padx=5, pady=8)

        Cole_Slaw_Lb = Label(Lb7, text='Cole Slaw', font=('times new roman', 16, 'bold'), bg=bg_color, fg='white')
        Cole_Slaw_Lb.grid(row=5, column=0, padx=5, pady=8, sticky='w')
        Cole_Slaw_txt = Entry(Lb7, width=5, font=('times new roman', 14, 'bold'), bd=5, relief=SUNKEN, textvariable=self.Cole_Slaw)\
            .grid(row=5, column=1, padx=5, pady=8)


        # *********** Order Area *********
        Lb5 = Frame(root, bd=10,relief=GROOVE,bg=bg_color)
        Lb5.place(x=990, y=150, width=295, height=340)

        Order_title = Label(Lb5, text='Order Area', font=('times new roman', 18, 'bold'), bd=7, bg=bg_color,
                            fg='gold', relief=GROOVE).pack(fill=X)
        ...
        Lb6.place(x=0, y=490, relwidth=1, height=160)
        ...
        drinks = Label(Lb6, text='Total Drinks Cost', font=('arial', 14, 'bold'), fg='white',bg=bg_color)\
            .grid(row=1, column=0, sticky='w', padx=5, pady=1)
        ...
        desert = Label(Lb6, text='Total Desert Cost', font=('arial', 14, 'bold'), fg='white',bg=bg_color)\
            .grid(row=2, column=0, sticky='w', padx=5, pady=1)
        ...
        sub_total = Label(Lb6, text='Sub Total', font=('arial', 14, 'bold'), fg='white',bg=bg_color)\
            .grid(row=0, column=2, sticky='w', padx=5, pady=1)
        ...
        service = Label(Lb6, text='Service', font=('arial', 14, 'bold'), fg='white',bg=bg_color)\
            .grid(row=1, column=2, sticky='w', padx=5, pady=1)
        ...
        total = Label(Lb6, text='Total Cost', font=('arial', 14, 'bold'), fg='white',bg=bg_color)\
            .grid(row=2, column=2, sticky='w', padx=5, pady=1)
    ...
    def Order_area(self):
        if self.C_name.get() == '':
            ...
            # j = [self.Burger, self.Pizza, self.Spaghetti, self.Chicken_Naggets, self.Mexican_Tacos, self.Hotdog]
            # for i in j:
            #     if i.get() != 0:
            #         self.textarea.insert(END, f' {i} \t\t{i.get()}\t{self.f_Burger_p}\n')
    ...
    def Save(self):
        ...
        if op > 0 :
            self.order_data = self.textarea.get('1.0', END)
            f1 = open("Order/" + str(self.order_no.get()) + ".txt", "w")
            f1.write(self.order_data)
            f1.close()
